interface Props { whatsapp: string; location: string; availability: string }
...
export default function ContactInfo({ whatsapp, location, availability }: Props) {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 text-[#8B1535]">
            <a href="#" aria-label="Instagram" className="hover:opacity-70 transition-opacity"><IconInstagram /></a>
            <a href="#" aria-label="Facebook" className="hover:opacity-70 transition-opacity"><IconFacebook /></a>
            <a href="#" aria-label="Pinterest" className="hover:opacity-70 transition-opacity"><IconPinterest /></a>
          </div>
        </div>
      </div>
